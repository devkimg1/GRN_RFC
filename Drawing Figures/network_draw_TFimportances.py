...
gt.draw.graph_draw(g, vertex_fill_color=state.get_blocks(), output="sbm10percent_tf.svg")
e = state.get_matrix()
plt.matshow(e.todense())
plt.colorbar()
plt.savefig("sbm_all_10percentthreshold_tf")
...
#name output based on threshold
gt.draw.draw_hierarchy(state, output='nestedsbm_all_10percentthreshold_tf.svg')
